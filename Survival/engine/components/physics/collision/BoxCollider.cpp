...
BoxCollider::BoxCollider(glm::vec2 position, glm::vec2 size, Entity * entity, Texture* texture, glm::vec2 coord)
	: m_centerPoint(0, 0) 
{
	...
	m_boundingBox = new Sprite2D(glm::vec3(position.x, position.y, 0), size, *texture, coord);
}
...
void BoxCollider::Update()
{
	...
	m_boundingBox->position = this->position;
